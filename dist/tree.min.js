...
(function(){function x(a){a.currentView.element.innerHTML=u.empty;I(a);ca(a);da(a);a.currentView.rows=p(a.currentView.element,"div","box-rows");N(a,a.currentView.rows,q[a.currentView.element.id].data);ea(a);B.addEventListener("resize",function(){N(a,a.currentView.rows,q[a.currentView.element.id].data)})}function da(a){var b=p(a.currentView.element,"div","title-bar");a.showTitle&&t(b,"div","title",a.titleText);if(1<a.currentView.categories.length&&(b=p(b,"div","controls"),a.showRefreshButton&&(t(b,
...
function n(a){return l(a)&&"string"===typeof a}function K(a){return l(a)&&"function"===typeof a}function J(a){return l(a)&&"number"===typeof a}function Q(a){return L(a)&&a instanceof Array}function y(a){K(a)&&a.apply(null,[].slice.call(arguments,1))}function w(a,b){return n(a)?a:b}function r(a,b){return P(a)?a:b}function F(a,b){return K(a)?a:b}function M(a,b){return J(a)?a:b}function la(a){var b=!0,f=null;try{n(a)&&(f=aa.parse(a))}catch(e){try{f=eval("("+a+")"),K(f)&&(f=f())}catch(d){h.safeMode||
(console.error("Errors in object: "+e.message+", "+d.message),b=!1),f=null}}return{parsed:b,result:f}}function Z(){for(var a=[],b=0;32>b;b++){8!==b&&12!==b&&16!==b&&20!==b||a.push("-");var f=H.floor(16*H.random()).toString(16);a.push(f)}return a.join(u.empty)}function ba(a){h=L(a)?a:{};h.safeMode=r(h.safeMode,!0);a=h;var b=h.domElementTypes,f=["*"];n(b)?(b=b.split(u.space),0===b.length&&(b=f)):b=Q(b)?b:f;a.domElementTypes=b;h.backButtonText=w(h.backButtonText,"Back");h.nextButtonText=w(h.nextButtonText,
...
space:" "},S={},q={};this.refresh=function(a){n(a)&&q.hasOwnProperty(a)&&(a=q[a].options,x(a),y(a.onRefresh,a.currentView.element));return this};this.refreshAll=function(){for(var a in q)if(q.hasOwnProperty(a)){var b=q[a].options;x(b);y(b.onRefresh,b.currentView.element)}return this};this.moveToPreviousCategory=function(a){n(a)&&q.hasOwnProperty(a)&&W(q[a].options);return this};this.moveToNextCategory=function(a){n(a)&&q.hasOwnProperty(a)&&X(q[a].options);return this};this.setConfiguration=function(a){for(var b in a)a.hasOwnProperty(b)&&
(h[b]=a[b]);ba(h);return this};this.getIds=function(){var a=[],b;for(b in q)q.hasOwnProperty(b)&&a.push(b);return a};this.getVersion=function(){return"0.4.0"};(function(a,b,f,e){A=a;B=b;H=f;aa=e;ba();A.addEventListener("DOMContentLoaded",function(){for(var d=h.domElementTypes,k=d.length,g=0;g<k;g++){var m=A.getElementsByTagName(d[g]);m=[].slice.call(m);for(var z=m.length,v=0;v<z;v++){var G=m[v],E=!0;if(l(G)&&G.hasAttribute("data-tree-options")){var c=G.getAttribute("data-tree-options");if(n(c))if(c=
la(c),c.parsed&&L(c.result)){c=c.result;var C=c=L(c)?c:{};var D=c.data;var T=[];D=Q(D)?D:T;C.data=D;c.maximumRows=M(c.maximumRows,10);c.spacing=M(c.spacing,10);c.maximumBoxHeight=M(c.maximumBoxHeight,200);c.reverseOrder=r(c.reverseOrder,!1);c.showBoxGaps=r(c.showBoxGaps,!0);c.swapSizes=r(c.swapSizes,!1);c.showBoxGapsForChildren=r(c.showBoxGapsForChildren,!1);c.allowBoxExpanding=r(c.allowBoxExpanding,!0);c.showTitle=r(c.showTitle,!0);c.showChildren=r(c.showChildren,!0);c.showDescriptions=r(c.showDescriptions,
!0);c.showContents=r(c.showContents,!0);c.tooltipDelay=M(c.tooltipDelay,750);c.showChildrenToggle=r(c.showChildrenToggle,!0);c.showDescriptionsToggle=r(c.showDescriptionsToggle,!0);c.showContentsToggle=r(c.showContentsToggle,!0);c.showCategorySelector=r(c.showCategorySelector,!0);c.showCategorySelectionDropDown=r(c.showCategorySelectionDropDown,!0);c.useDecreasingHeightsForBoxes=r(c.useDecreasingHeightsForBoxes,!0);c.showRefreshButton=r(c.showRefreshButton,!1);c.onBeforeRender=F(c.onBeforeRender,
...
null;c.currentView.category=0<C.length?C[0]:null;c.currentView.categories=C;c.currentView.categoryText=null;c.currentView.categoryIndex=0;c.currentView.fullScreenBoxId=null;c.currentView.fullScreenBoxHeight=null;y(c.onBeforeRender,c.element);n(c.currentView.element.id)||(c.currentView.element.id=Z());c.currentView.element.className="tree-js";c.currentView.element.removeAttribute("data-tree-options");c.currentView.rows=null;q.hasOwnProperty(c.currentView.element.id)||(q[c.currentView.element.id]={},
q[c.currentView.element.id].options=c,q[c.currentView.element.id].data=c.data,delete c.data);x(c);y(c.onRenderComplete,c.currentView.element)}else h.safeMode||(console.error("The attribute 'data-tree-options' is not a valid object."),E=!1);else h.safeMode||(console.error("The attribute 'data-tree-options' has not been set correctly."),E=!1)}if(!E)break}}});l(B.$tree)||(B.$tree=this)})(document,window,Math,JSON)})();