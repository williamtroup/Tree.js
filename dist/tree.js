/*! Tree.js v0.1.0 | (c) Bunoon 2024 | MIT License */
(function() {
    function render() {
    ...
    function renderControlFooter(bindingOptions) {
      ...
      var showDescriptions = buildCheckBox(footer, _configuration.showDescriptionsLabelText, bindingOptions.showDescriptions, onClick)[0];
      var showContents = buildCheckBox(footer, _configuration.showContentsLabelText, bindingOptions.showContents, onClick)[0];
    }
